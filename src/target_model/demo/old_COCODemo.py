...
class COCODemo(object):
	...
	def run_on_opencv_image(self, image):
		...
		#top_prediction, return_score, return_label, return_bbox = self.select_top_predictions(predictions)
		mean_score, labels, real_labels = self.get_scores(predictions)
		#print("top score:{},label:{},bbox:{}".format(top_predictions.get_field('scores'),top_predictions.get_field('labels'),top_predictions.bbox))
		#print(return_score.shape)
		return mean_score, labels, real_labels#top_prediction, return_score, return_label, return_bbox
